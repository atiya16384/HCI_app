...
export default class PrioritiseScreen extends React.Component{
  constructor(props){
    super(props);
    this.state = {
      ...
      <Animated.ScrollView contentContainerStyle={styles.container} style={{opacity: fadeAnim}}>
        ...
        this.state.showPage1 ?
          <View style={styles.container}>
            ...
            To prioritise your strivings, you should rank your strivings in order of importance
            so you know which strivings to focus on.
            </Text>
...
PrioritiseScreen.navigationOptions = {
  headerStyle: {
