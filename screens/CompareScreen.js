    ...
    return (
      <Animated.ScrollView contentContainerStyle={styles.container} style={{opacity: fadeAnim}}>
        ...
        <View style={styles.container}>
          ...
          Now that you have re-prioritised your strivings, you should compare your strivings to
          understand whether and how they have changed since reflecting on your strivings.
          </Text>
        ...
        <View style={styles.container}>
          <Text style={styles.title}>Compare</Text>
          <Text style={{textAlign:'center', margin: 5, fontSize: 14}}>
          Consider how the importance of your strivings may have changed since you reflected on your strivings
          </Text>
          <Text>(1 = Most Important) (10 = Least Important)</Text>
          <View style={styles.priorityRow}>
            <View style={{width:'12%', backgroundColor: 'transparent'}}>
              <Text style={{fontWeight: 'bold', fontSize: 10}}> Prioritise</Text>
            </View>
            <View style={{width:'14%', backgroundColor: 'transparent'}}>
              <Text style={{fontWeight: 'bold', fontSize: 10}}>Re-prioritise</Text>
            </View>
            <View style = {{width: '74%', backgroundColor: 'transparent'}}></View>
          </View>
          <View style={styles.priorityRow}>
